...
<!-- OPTIMIZATION_ZONE_START: 字段完整性检查 -->
<!-- 此区域包含针对字段缺失、端口配置等实际失败模式的补充检查 -->
<!-- OPTIMIZATION_ZONE_END: 字段完整性检查 -->

<!-- OPTIMIZATION_ZONE_START: 单位与数值检查 -->
<!-- 此区域包含针对单位不匹配、数值范围等实际失败模式的补充检查 -->
<!-- OPTIMIZATION_ZONE_END: 单位与数值检查 -->

<!-- OPTIMIZATION_ZONE_START: 设备特定检查 -->
<!-- 此区域包含针对特定设备类型实际失败模式的补充检查 -->
<!-- OPTIMIZATION_ZONE_END: 设备特定检查 -->
"""
